...
const ExperiencePreviewCard: React.FunctionComponent<props> = ({ title, data, handleEdit }) => {
    ...
    return (
        <div className="info__container">
            ...
            <div className="my-4">
                <OutlineButton text="Add More" width="10rem" btnClick={context.experienceBack} />
            </div>
